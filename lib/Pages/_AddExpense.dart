                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border.all(color: AppPallete.gradient2, width: 2),
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            menuItems![activeOption].menuIcons.path,
                            height: 50,
                            width: 50,
                          ),
                          Text(
                            ...
                            style: TextStyle(fontFamily: 'thaifont', fontWeight: FontWeight.bold, color: Colors.white, fontSize: 10.0),
                            softWrap: true,
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              ...
                              children: [
                                Image.asset(
                                  menuItems![index].menuIcons.path,
                                  width: 35,
                                  height: 35,
                                ),
                                Text(
                                  ...
                                  textAlign: TextAlign.center,
                                  style: TextStyle(fontFamily: 'thaifont', fontWeight: FontWeight.bold, color: AppPallete.gradient1, fontSize: 8.0),
                                  softWrap: true,
                                  overflow: TextOverflow.visible,
                                )
                              ],
